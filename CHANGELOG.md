...
_Warning: May contain traces of excessive purple enthusiasm and developer humor._

## [2.0.1] - 2025-08-09

### 🍊➡️💜 THE GREAT ORANGE PURGE - "Operation Purple"

Breaking news from the Department of Color Correctness: We have successfully eliminated the Orange Menace from our beautiful purple kingdom! This emergency hotfix was deployed after numerous reports of "aggressive orange" causing visual distress in sidebars worldwide.

#### 🚨 Critical Bug Fixes (The Orange Intervention)

- **ELIMINATED** the orange folder menace from file explorer sidebars (orange is so 2023, purple is eternal)
- **NEUTRALIZED** bright orange git decorations that were trying to steal purple's spotlight
- **REPLACED** orange with sophisticated gray tones because sometimes you need backup dancers for the purple star
- **UPGRADED** modified file colors from "LOOK AT ME I'M ORANGE" to "I'm subtly gray and purple-adjacent"
- **BANISHED** orange find highlights in favor of proper purple supremacy
- **CONVERTED** warning colors from orange chaos to civilized amber (orange's more sophisticated cousin)

#### 🎨 Color Psychology Improvements

- Sidebar text now speaks in soothing gray whispers instead of orange screams
- File tree colors now practice proper purple etiquette
- Git decorations have been enrolled in Purple Sensitivity Training
- All colors now bow appropriately to their purple overlords

#### 🦄 User Testimonials

- _"Finally, I can look at my sidebar without my retinas filing a complaint!"_ - Anonymous Developer
- _"My cat stopped hiding when I opened VS Code. Thanks, Purply Team!"_ - Cat Owner #47
- _"I make up testimonials because I'm the only one using this."_ - Purply Creator

### 💜 What We Learned

Orange may be the new black, but purple is the eternal monarch of the color spectrum. We apologize for any temporary orange-induced trauma and have implemented strict No-Orange policies going forward.

---

## [2.0.0] - 2025-08-09

### 🎉 MAJOR RELEASE - The Purple Awakening

Ladies, gentlemen, and all coding wizards, behold! We've taken the old Purply Theme out back, given it a complete makeover, and taught it how to be fabulous. This is basically the theme equivalent of a glow-up montage in a 90s movie.

### ✨ Added (The Purple Treasures)

#### 🎨 Visual Improvements (Making Your Eyes Happy)
...
#### 🔥 Syntax Highlighting (The Code Fashion Show)
...
#### 📋 Theme Variants (Choose Your Purple Adventure)
...
#### 🛠️ Developer Experience (Quality of Life Improvements)
...
### 🎯 Improved (Making Good Things Even Better)

#### 🎨 Color Consistency (The Purple Harmony Project)
...
#### 🔧 Code Readability (Making Code Less Scary)
...
#### 📱 UI/UX (User Experience Wizardry)
...
### 🔧 Changed (The Makeover Edition)

#### 🎨 Visual Updates (Purple Glow-Up)
...
#### 📦 Package Updates (The Business Side of Purple)
...
### 🐛 Fixed (The Bug Extermination Squad)

#### 🎨 Color Issues (Purple Problems Solved)
...
#### 🔧 Syntax Issues (Code Therapy Session)
...
#### 📋 Theme Issues (The Annoying Stuff Nobody Talks About)
...
### 🗑️ Removed (The Digital Spring Cleaning)
...
## [1.0.0] - The "Release" Release

### Added

- Twas released, and twas purply.

## 📄 License (The Legal Purple Print)
...
**Made with 💜, questionable life choices, and an unhealthy obsession with the color purple by the Purply Theme team**

_P.S. - If you're reading this far down in a changelog, you might be as obsessed with details as we are with purple. We respect that._
